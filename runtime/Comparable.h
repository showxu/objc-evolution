...
+ (BOOL (^)(id lhs, id rhs))lessThan; // FIXME: operator override (<)
...
///   - lhs: A value to compare.
///   - rhs: Another value to compare.
+ (BOOL (^)(id lhs, id rhs))lessThanOrEqualTo; // FIXME: operator override (<=)
    // public static func <=(lhs: Self, rhs: Self) -> Bool
...
///   - lhs: A value to compare.
///   - rhs: Another value to compare.
+ (BOOL (^)(id lhs, id rhs))greaterThanOrEqualTo; // FIXME: operator override (>=)
    // public static func >=(lhs: Self, rhs: Self) -> Bool
...
///   - lhs: A value to compare.
///   - rhs: Another value to compare.
+ (BOOL (^)(id lhs, id rhs))greaterThan; // FIXME: operator override (>)
    // public static func >(lhs: Self, rhs: Self) -> Bool
